...
function emptyAlternateNames(charactersArray) {
    return charactersArray.filter(character => character.alternate_names.length === 0);
}

const alternateNames = emptyAlternateNames(characters);
